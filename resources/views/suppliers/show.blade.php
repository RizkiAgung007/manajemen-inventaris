                ...
                <div class="p-6">
                    ...
                    <dl class="border-t border-gray-200 pt-4 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-6 text-sm">
                        <div>
                            ...
                            <dd class="mt-1 text-gray-900">{{ $supplier->email ?? '-' }}</dd>
                        </div>
                        <div>
                            <dt class="font-medium text-gray-500">Telepon</dt>
                            <dd class="mt-1 text-gray-900">{{ $supplier->phone ?? '-' }}</dd>
                        </div>
                        <div class="sm:col-span-2">
                            <dt class="font-medium text-gray-500">Alamat</dt>
                            <dd class="mt-1 text-gray-900">{{ $supplier->address ?? '-' }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($supplier->products as $product)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 text-sm">{{ $product->stock }} unit</td>

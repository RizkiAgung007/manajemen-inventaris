                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                <a href="{{ route('suppliers.show', $supplier->id) }}" class="p-2 text-gray-400 hover:text-blue-600 rounded-md hover:bg-blue-100" title="Detail">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>

                                                @can('manage-content')
                                                    <a href="{{ route('suppliers.edit', $supplier->id) }}" class="p-2 text-gray-400 hover:text-yellow-600 rounded-md hover:bg-yellow-100" title="Edit">

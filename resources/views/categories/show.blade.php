                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Detail informasi mengenai kategori.</p>
                        </div>
                    ...
                    <dl class="border-t border-gray-200 pt-4 grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                        <div>
                            <dt class="font-medium text-gray-500">Jumlah Produk</dt>
                            <dd class="mt-1 text-gray-900 font-semibold">{{ $category->products->count() }} Produk</dd>
                        </div>
                        <div>
                            <dt class="font-medium text-gray-500">Total Stok Unit</dt>
                            <dd class="mt-1 text-gray-900 font-semibold">{{ $category->products->sum('stock') }} Unit</dd>
                        </div>
                        <div>
                        ...
                        <div class="sm:col-span-2">
                            <dt class="font-medium text-gray-500">Disediakan Oleh</dt>
                                ...
                                @forelse ($category->products as $product)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-xs text-gray-500">Pemasok: {{ $product->supplier->name ?? 'N/A' }}</div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 text-right align-middle">
                                            <a href="{{ route('products.show', $product->id) }}" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">Lihat Detail</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>

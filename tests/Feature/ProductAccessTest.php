...
class ProductAccessTest extends TestCase
{
    ...
    // ===== TEST AKSES =====
    public function test_guests_are_redirected_to_login_when_accessing_products(): void
    {
        $response = $this->get('/dashboard/products');
        $response->assertRedirect('/login');
    }

    public function test_users_with_role_user_are_forbidden_from_accessing_products(): void
    {
    ...
    public function test_superadmin_users_can_access_products(): void
    {
        ...
        $response = $this->actingAs($superadmin)->get('/dashboard/products');
        $response->assertOk();
    }
